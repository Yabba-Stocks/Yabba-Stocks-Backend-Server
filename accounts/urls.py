...
urlpatterns = [
    ...
    path("password-verify-otp/", PasswordVerifyOTP.as_view(), name="password_verify_otp"),
    ...
    path("password-resend-otp/", PasswordResendOTP.as_view(), name="password_resend_otp"),
]
